...
namespace {
    ...
    class PackageManager extends \KodiCMS\Assets\Facades\PackageManager{
        ...
        public static function union($items){
            //Method inherited from \Illuminate\Support\Collection            
            \KodiCMS\Assets\PackageManager::union($items);
        }
    ...
    class AdminNavigation extends \SleepingOwl\Admin\Facades\Navigation{
         ...
         * 
         *
         * @param string|array|\KodiComponents\Navigation\PageInterface|null $page
         ...
         * 
         *
         * @return \KodiComponents\Navigation\Collection 
         * @static 
         */
        ...
        public static function getCurrent(){
            //Method inherited from \KodiComponents\Navigation\Navigation            
            return \SleepingOwl\Admin\Navigation::getCurrent();
        }
         ...
         *
         * @param string $title
         * @return \KodiComponents\Navigation\Page|false 
         * @static 
         */
